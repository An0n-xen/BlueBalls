...
async def get_dataset_data(dataset_id: str, limit: int = 100, offset: int = 0, db: AsyncSession = Depends(get_async_db)):
    logger.info(f"Getting data for dataset {dataset_id} (limit={limit}, offset={offset})")
    try:
